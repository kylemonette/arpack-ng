...
c  every restart is performed via mydnaup2_house -- a fork of dnaup2
c  that applies the NONSYMMETRIC ARROWHEAD restart (mydnapps_house, via
c  LAPACK's DGEHRD/DORGHR) instead of classical implicit-shift bulge
c  chasing. See
c
...
c
c\Routines called:
c     mydnaup2_house Local fork of dnaup2 that additionally computes
c              the real
...
c     %----------------------%
c
      external   mydnaup2_house ,  dvout , ivout, arscnd, dstats
c
c     %--------------------%
...
c
 ...
 1000    format (//,
     ...
     &      5x, '= (nonsymmetric arrowhead restart, House)   =',/
