...
c
c\Routines called:
c     mydnaup2_house Local fork of dnaup2 (ARPACK routine that
c             implements the Implicitly Restarted Arnoldi Iteration)
c             that additionally computes the real Schur decomposition
c             of the current KEV+NP Hessenberg matrix (via LAPACK's
c             DGEHRD/DORGHR) and passes it into mydnapps_house.
...
c
c\SCCS Information: @(#)
c FILE: mynaupd_house.F   SID: 2.8   DATE OF SID: 04/10/01   RELEASE: 2
c
c\Remarks
c
c\EndLib
...
c     %----------------------%
c
      external   mydnaup2_house , dvout , ivout, arscnd, dstatn
c
c     %--------------------%
